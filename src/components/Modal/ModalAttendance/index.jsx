...
function ModalAttendance({ data, role }) {
  ...
  const [updateMeetNumber, { loading: loadingMeetNumber }] = useMutation(
    UPDATE_MEET_NUMBER,
    {
      variables: {
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              <div className="flex justify-between items-center p-5 rounded-t border-b dark:border-gray-600">
                <h3 className="text-xl font-medium text-gray-900 dark:text-white">
                  Attendance {assignValue.course_name} -{" "}
                  {assignValue.class_name}
                </h3>
              ...
              {data.meet_number !== 61 ? (
                <>
                  <div className="flex px-6 py-2 justify-start">
                    {role === "lecturer" ? (
                      <HeaderAttendance
                        meet={assignValue.meet_number}
                        schedule_data={data}
                      />
                    ) : (
                      <FilterMeetNumber />
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div className="p-6 text-center">
                ...
                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                  Are you sure you want to complete the Attendance Session{" "}
                  {data.meet_number + 1} ?
                  <br />
                </h3>
                <button
