...
function ModalUpdateSchedule({ data }) {
  ...
  const { data: dataCourses } = useQuery(GET_COURSES, {
    variables: { prodi: id_prodi },
  });
  ...
  const handleUpdate = (e) => {
    e.preventDefault();
    if (
      scheduleUpdate.course_id === data.course.course_id &&
      scheduleUpdate.class_id === data.class.id &&
              ...
              <div className="p-6 space-y-6">
                <form onSubmit={handleUpdate}>
                  ...
                  <div className="relative z-0 w-full mb-6 group">
                    <label
                      htmlFor=""
                      className="text-primary-grey dark:text-white text-sm"
                    >
                      Time :
                    </label>
                    <div className="flex flex-row justify-center items-center gap-x-4">
                      <input
                        ...
                        className="bg-gray-50 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      />
                      <p className="text-primary-grey dark:text-white text-sm">
                        s/d
                      </p>
                      <input
                        autoComplete="off"
