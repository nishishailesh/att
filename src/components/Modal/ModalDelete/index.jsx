              ...
              <div className="p-6 text-center">
                ...
                {type === "student" ? (
                  <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                    Are you sure you want to delete Student <br /> <b>{studentDelete.fullname}</b>
                  </h3>
                ) : type === "lecturer" ? (
                  <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                    Are you sure you want to delete Lecturer <br /> <b>{lecturerDelete.fullname}</b>
                  </h3>
                ) : type === "class" ? (
                  <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                    Are you sure you want to delete Class <br /> <b>{classNameDelete.class_name}</b>
                  </h3>
                ) : type === "course" ? (
                  <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                    Are you sure you want to delete a Course <br /> <b>{courseDelete.course_name}</b>
                  </h3>
                ) : (
                  <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                    Are you sure you want to delete Schedule & Attendance for Class <br />{" "}
                    <b>
                ...
                <button type="button" className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2" onClick={handleDelete}>
                  {loadingDeleteStudent || loadingDeleteLecturer || loadingDeleteClassName || loadingDeleteCourse || loadingDeleteSchedule ? <LoadingAnimation /> : "Yes"}
                </button>
                <button
                  type="button"
