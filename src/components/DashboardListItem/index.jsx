      ...
      <div className="shadow-2xl h-max relative rounded-3xl dark:bg-primary-black bg-primary-white lg:w-1/3 w-1/2 p-5">
        <div className="justify-center flex flex-col gap-y-5">
          <div className="flex flex-row justify-center items-end ">
            ...
            <div className="dark:text-white text-primary-grey opacity-50 text-center text-sm ">Student</div>
          </div>
          <div className="dark:text-white text-primary-grey text-center lg:text-sm text-xs">Active Student</div>
        </div>
      </div>
      <div className="shadow-2xl h-max relative rounded-3xl dark:bg-primary-black bg-primary-white lg:w-1/3 w-1/2 p-5">
        <div className="justify-center flex flex-col gap-y-5">
          ...
          <div className="dark:text-white text-primary-grey text-center lg:text-sm text-xs">Inactive Student</div>
        </div>
      </div>
      <div className="shadow-2xl h-max relative rounded-3xl dark:bg-primary-black bg-primary-white lg:w-1/3 w-1/2 p-5">
        <div className="justify-center flex flex-col gap-y-5">
          ...
          <div className="dark:text-white text-primary-grey text-center lg:text-sm text-xs">Total Student</div>
        </div>
      </div>
      <div className="shadow-2xl h-max relative rounded-3xl dark:bg-primary-black bg-primary-white lg:w-1/3 w-1/2 p-5">
        <div className="justify-center flex flex-col gap-y-5">
          <div className="flex flex-row justify-center items-end ">
            ...
            <div className="dark:text-white text-primary-grey opacity-50 text-center text-sm  ">Lecturer</div>
          </div>
          <div className="dark:text-white text-primary-grey text-center lg:text-sm text-xs">Total Lecturers</div>
        </div>
      </div>
    </div>
  );
